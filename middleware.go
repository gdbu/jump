...
func (j *Jump) NewSetUserIDMW(redirectOnFail, allowNonLoggedIn bool) (fn httpserve.Handler) {
	return func(ctx *httpserve.Context) {
		var (
			userID string
			err    error
...
func (j *Jump) getUserIDFromRequest(ctx *httpserve.Context) (userID string, err error) {
